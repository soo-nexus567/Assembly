...
//    Editor: VS Code
//    Link: gcc -m64 -Wall -fno-pie -no-pie -z noexecstack -o learn.out
//    triangle.o geometry.o -lm
#include <stdio.h>
...
int main() {
  ...
  printf(
      "If errors are discovered please report them to Juan Diaz at "
      "juan@columbia.com  for a quick fix.  At Columbia Software the customer "
      "comes first.\n");
